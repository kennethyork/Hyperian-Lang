...
if [ "$platform" = android ]; then
    ...
    grep 'kind.equals("table")' "$android/app/src/main/java/com/hyperian/generated/MainActivity.java"
    grep 'kind.equals("tableHeading")' "$android/app/src/main/java/com/hyperian/generated/MainActivity.java"
    grep 'HorizontalScrollView scrolling' "$android/app/src/main/java/com/hyperian/generated/MainActivity.java"
    grep 'kind.equals("choice")' "$android/app/src/main/java/com/hyperian/generated/MainActivity.java"
    grep 'Spinner input' "$android/app/src/main/java/com/hyperian/generated/MainActivity.java"
...
if [ "$platform" = ios ]; then
    ...
    grep 'case "table"' "$ios/HyperianIOS/ContentView.swift"
    grep 'case "tableHeading"' "$ios/HyperianIOS/ContentView.swift"
    grep 'case "choice"' "$ios/HyperianIOS/ContentView.swift"
    grep 'Picker(control.label' "$ios/HyperianIOS/ContentView.swift"
