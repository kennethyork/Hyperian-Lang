...
const char *opcode_name(uint8_t op) {
    static const char *names[] = {"INVALID", "APPLICATION", "PORT", "MODEL", "FIELD", "END_MODEL",
        ...
        "POLYGON", "CHECK_POLYGON_COLLISION", "CHECK_POLYGON_LINE_COLLISION",
        "CHECK_POLYGON_CIRCLE_COLLISION", "CHECK_POLYGON_RECTANGLE_COLLISION",
        "PLAY_MUSIC", "PAUSE_MUSIC", "RESUME_MUSIC", "STOP_MUSIC", "SET_MUSIC_VOLUME",
        "VIEW_ROW", "END_VIEW_ROW", "VIEW_COLUMN", "END_VIEW_COLUMN", "VIEW_CARD", "END_VIEW_CARD",
        "VIEW_TABLE", "END_VIEW_TABLE", "TABLE_HEADING", "TABLE_ROW", "END_TABLE_ROW", "TABLE_CELL",
        "CHOICE", "END_CHOICE", "CHOICE_OPTION"};
