...
#define HYPERIAN_VERSION "0.51.0"
...
typedef enum {
    ...
    OP_VIEW_ROW, OP_END_VIEW_ROW, OP_VIEW_COLUMN, OP_END_VIEW_COLUMN, OP_VIEW_CARD, OP_END_VIEW_CARD,
    OP_VIEW_TABLE, OP_END_VIEW_TABLE, OP_TABLE_HEADING, OP_TABLE_ROW, OP_END_TABLE_ROW, OP_TABLE_CELL,
    OP_CHOICE, OP_END_CHOICE, OP_CHOICE_OPTION
} OpCode;
